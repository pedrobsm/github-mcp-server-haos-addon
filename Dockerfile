...
RUN ARCH=$(uname -m) && \
    ...
    elif [ "$ARCH" = "armv7l" ]; then GITHUB_ARCH="Linux_arm64"; \
    else echo "Unsupported architecture: $ARCH"; exit 1; fi && \
    curl -fsSL "https://github.com/github/github-mcp-server/releases/download/v0.30.3/github-mcp-server_${GITHUB_ARCH}.tar.gz" -o /tmp/mcp.tar.gz && \
